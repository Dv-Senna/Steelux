...
namespace sl::utils {
	constexpr Logger::Logger(const sl::String &name, std::ostream &stream) noexcept :
		Logger(name, DEFAULT_SEVERITY_MASK, DEFAULT_FORMAT_STRING, stream) {}
	constexpr Logger::Logger(const sl::String &name, sl::utils::FlagField<LogSeverity> severityMask, std::ostream &stream) noexcept :
		Logger(name, severityMask, DEFAULT_FORMAT_STRING, stream) {}
	constexpr Logger::Logger(const sl::String &name, FormatString formatString, std::ostream &stream) noexcept :
		Logger(name, DEFAULT_SEVERITY_MASK, formatString, stream) {}


	constexpr Logger::Logger(const sl::String &name, sl::utils::FlagField<LogSeverity> severityMask, FormatString formatString, std::ostream &stream) noexcept :
		m_name {name},
